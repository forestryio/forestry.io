...
In this example, the image is in the item's front matter and has the key of `image` (e.g. `image: "/uploads/picture.jpg"`). Replace `.Params.image` with the name of your front matter field if this is different.
