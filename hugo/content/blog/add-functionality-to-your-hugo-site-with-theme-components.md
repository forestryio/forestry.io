...
<div style="margin-top: 2em; padding: 20px 40px;background: #f7f7f7;"><h2>Join us every Friday :date:</h2><p><a href="/categories/frontend-friday/">Frontend Friday</a> is a weekly series where we write in-depth posts about modern web development.</p><p><strong>Next week:</strong> Creating a Form Builder With Formspree and Forestry Blocks</p><p><strong>Last week:</strong> We showed you how <a href="https://forestry.io/blog/harness-the-power-of-static-to-create-presentations/">Reveal.JS + Hugo and Forestry make a great team for your next slide deck</a></p></div>
