...
---
As of writing this Jekyll’s performance is still actively being worked on by the Core Team for an upcoming version 4 release. One of the main complaints about Jekyll for users is often the build times of larger websites. I want to take this opportunity to see just how much I can expect to improve my current site build times by using the latest master branch.
...
As you can see above, Jekyll **3.8.5** manages to build my website which has **277** posts and **30** pages in **16.114** seconds. Not bad but we can definitely improve this.

# 16.114 seconds

[6e11a1b](https://github.com/desiredpersona/jekyll-test-site/commit/6e11a1b0891a6991df8597cd40d34da2a292e0ad)
...
[b572c61](https://github.com/desiredpersona/jekyll-test-site/commit/b572c61bf6c8f6adea79185831c82d8e71aa70b4)
...
[977fd24](https://github.com/desiredpersona/jekyll-test-site/commit/977fd247c2f3cbf9ac3c5fb876c228881c464400)
...
[bbb1e15](https://github.com/desiredpersona/jekyll-test-site/commit/bbb1e15dc16dd73aeaa00c7f67b40272ca125ef5)


### 4. Use Jekyll Include Cache plugin

To see how Jekyll `_includes` affect site build times, we need to take another look at the build profile. Right away you can see some include files are being called hundreds of times creating a performance bottleneck.
...
The `blog.html` layout created a bottlenecks during build time because it lists all 277 posts. By limiting this to the latest 10 posts [67840bb](https://github.com/desiredpersona/minimal-jekyll-theme/commit/67840bbfb80c58d746e4f58ee1eb99f69819c404) and archiving older posts with just a date and title I reduced the amount of includes being generated at build time. [4c0fd29](https://github.com/desiredpersona/minimal-jekyll-theme/commit/4c0fd29dfe218e5da007aa14fe0a1388e3bb43d1)


Done tidying up your Jekyll `_includes`?

We can now make use of [Ben Balter’s](https://ben.balter.com) [jekyll-include-cache](https://github.com/benbalter/jekyll-include-cache) a Jekyll plugin that will cache the rendering of our Liquid includes.
...
[264db43](https://github.com/desiredpersona/jekyll-test-site/commit/264db43d64760637b9e752104a44d0e9b81e81eb)
...
You can also set `incremental: true` in Jekyll’s `_config` file. Im seeing build times as low as **5.11** seconds with this feature enabled.
