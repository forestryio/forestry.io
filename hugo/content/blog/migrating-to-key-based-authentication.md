...
**Bitbucket users:** Unfortunately, we are currently unable to automatically set up SSH keys for Bitbucket projects. To migrate your Bitbucket project, you will want to follow the **"completing the connection"** steps from our [manual project setup](/docs/git-sync/manual-setup#completing-the-connection) guide.
