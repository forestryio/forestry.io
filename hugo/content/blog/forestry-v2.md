...
This migration would also involve switching out the Forestry Admin UI with the [TinaCMS](http://tina.io/) UI. TinaCMS is our open-source front-end editor and is similar to the Forestry [Remote Admin](https://forestry.io/docs/editing/remote-admin/) but includes a live preview next to your editing fields.

![](https://res.cloudinary.com/forestry-demo/image/upload/v1619023278/tina-cms-visual-editing.gif)

We’re excited about the value that TinaCMS and Tina Cloud will unlock for our users: visual editing, open-source and pluggable architecture, multi-branch workflows, and more.