...
For teams that need more advanced collaborators & teams Forestry provides [Organizations](/docs/settings/collaborators#organizations). Organizing editors, developers and admins in [User roles](/docs/settings/collaborators#site-access-levels) makes managing your whole team across multiple sites simple (paid feature).
