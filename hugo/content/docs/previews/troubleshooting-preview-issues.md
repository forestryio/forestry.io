...
If you're attempting to preview your site and you encounter an error like *failed to build preview*, *error generating preview*, or *failed to create preview*, there was a problem building your preview. 
