...
## S3 Redirects
[Hugo aliases](https://gohugo.io/content-management/urls/#aliases) handles the site's redirects.  A valid S3 redirects configuration is generated using [custom output formats](https://gohugo.io/templates/output-formats/).
